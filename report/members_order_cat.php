...
$sql = "select * from home order by category";
...
<html>
<head>
<title>Total Members Ordered By Category</title>
<style>
#db_table ,
#db_table th,
#db_table td {
...
$header = "<h2 style='text-align:center;'>".$xml->MasjidName."</h2> "
        ...
        . "<h3 style='text-align:center;'>Total Members Ordered By Category Report</h3>"
