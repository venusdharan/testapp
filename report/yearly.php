...
$sql = "SELECT * FROM expense where YEAR(date) = '$date'";
...
$sql1 = "SELECT * FROM income where YEAR(date) = '$date' ";
...
$header = "<h2 style='text-align:center;'>".$xml->MasjidName."</h2> "
        ...
        . "<h3 style='text-align:center;'>Total Annual Account Report</h3>"
...
$mpdf->debug = true;
$mpdf->Output('Meezan Annual Account Report.pdf', 'I');
header("Content-Type: application/pdf");
header("Content-Disposition: attachment; filename= Meezan Annual Account Report.pdf");
