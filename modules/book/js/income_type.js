...
$.post("modules/book/income_type_p.php",{op:'all',data:'ward'},function(d,s){
...
$(document).on("click",".delbtncls",function(){
   ...
   var result = confirm("Want to delete?");
    if (result) {
        $.post("modules/book/income_type_p.php",{op:'del',data:id},function(d,s){
...
$("#modal_sub").on("click",function(){
    ...
    if(ward !== "")
    {
    $.post("modules/book/income_type_p.php",{op:'add',data:ward},function(d,s){
       if(d.trim() !== "Failed")
       {
           //alert(d);
