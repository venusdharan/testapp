...
$home = new content("Search Membership","Welcome user");
$table = '
...
<button class="btn btn-info"  id="table-add"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Update Members</button>
</div>
...
<div class="form-group" id="sel1_div">
