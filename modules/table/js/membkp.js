...
$("#table-add").on( 'click',function(){
    ...
    $.each(cols,function(value,key){
            ...
            if(key.type == "select")
            {
              ...
              modal_controls += '<div class="form-group"><label for="'+key.title+'">'+key.title+':</label>  <select class="input-large selectpicker form-control"  data-live-search="true" style="width:100%;" name="'+key.cname+'" id="'+key.title+'" data-style="btn-primary" title="'+key.title+'">'+selects+'</select></div>';   
            ...
            if(key.type == "number")
            {
              modal_controls += '<div class="form-group"><label for="'+key.title+'">'+key.title+':</label><input type="number" class="form-control" name="'+key.cname+'" id="'+key.title+'" placeholder="Enter '+key.title+'"></div>'; 
            }
            
            if(key.type == "email")
            {
              modal_controls += '<div class="form-group"><label for="'+key.title+'">'+key.title+':</label><input type="email" class="form-control" name="'+key.cname+'" id="'+key.title+'" placeholder="Enter '+key.title+'"></div>'; 
            }
