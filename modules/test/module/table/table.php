...
$home = new content("Table","Welcome user");
$table = '
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-default btn-success pull-left" id="modal_sub"><span class="glyphicon glyphicon-off"></span>Apply</button>
        </div>
      </div>
    </div>
  </div> '
