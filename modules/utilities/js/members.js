...
var table = $('#example').DataTable( {
       ...
       // data: dataSet,
        "processing": true,
	"serverSide": true,
	"ajax": "modules/utilities/members_processing.php",
        columns:cols ,
        buttons: [
            {
                extend: 'colvis',
...
if(operation == "del")
{
$.post("modules/utilities/members_delete.php",{"id":from_data}, function(data, status){
         alert("Data: " + data + "\nStatus: " + status);
...
if(form_valid)
{
$.post("modules/utilities/members_db.php",
{
  op:"add",
  data:result
},function(d,s){
...
$("#table-delete").on( 'click',function(){
    ...
    if(r)
    {
         ...
         console.log(table_selected_row);
         $.post("modules/utilities/members_delete.php",{id:table_selected_row},function(d,s){
